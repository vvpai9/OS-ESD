...
// compatible with  ALS-SDA-ARM7-08 REV00. 
// Implementations done for 0th channel.
//----------------------------------------------------------
...
int main()
{
	...
	IO1DIR =  0X00F70000 ;		// 	P1.16(adr0),P1.17(adr1),P1.18(out_en)  MADE OUTPUTS & p1.19(EOC) made input
